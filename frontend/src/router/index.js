...
import HRExpenseReports from "../components/HRExpenseReports.vue";
...
import BDAExpensePage from "../components/BDAExpensePage.vue";
import BDAEODPage from "../components/BDAEODPage.vue";
import BDABehavioralInterviewPage from "../components/BDABehavioralInterviewPage.vue";
import BDALeavePage from "../components/BDALeavePage.vue";
import BDANotificationsPage from '../components/BDANotificationsPage.vue'
import HONotificationsPage from '../components/HONotificationsPage.vue'
import CandidateNotificationsPage from '../components/CandidateNotificationsPage.vue'
import HRNotificationsPage from '../components/HRNotificationsPage.vue'
import HODashboard from "../components/HODashboard.vue";
import CandidateOnboarding from "../components/CandidateOnboarding.vue";
import HROnboarding from "../components/HROnboarding.vue";
import HRJobPostings from "../components/HRJobPostings.vue";
import HRApplications from "../components/HRApplications.vue";
import HRPerformanceReviews from "../components/HRPerformanceReviews.vue";
import HRCourseManagement from "../components/HRCourseManagement.vue";
import HREmployees from "../components/HREmployees.vue";
import CandidateTasks from "../components/CandidateTasks.vue";
import TaskManagement from "../components/TaskManagement.vue";
import HOTechnicalInterviews from "../components/HOTechnicalInterviews.vue"; import HOLeavePage from "../components/HOLeavePage.vue";
import HOVacancyPage from "../components/HOVacancyPage.vue";
...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      name: "HRExpenseReports",
      component: HRExpenseReports,
      meta: { requiresAuth: true, role: "hr" },
    },
    {
      path: "/hr/course-management",
      name: "HRCourseManagement",
      component: HRCourseManagement,
      meta: { requiresAuth: true, role: "hr" },
    },
    {
    ...
    },
    {
      ...
      name: "CandidateNotificationsPage",
    ...
    },
    {
      ...
      component: HRPerformanceReviews,
      meta: { requiresAuth: true, role: "hr" },
    },
    {
      path: "/bda/dashboard",
    ...
    },
    {
      path: "/bda/expenses",
      name: "BDAExpensePage",
      component: BDAExpensePage,
      meta: { requiresAuth: true, role: "bda" },
    },
    {
      path: "/bda/eod",
      name: "BDAEODPage",
      component: BDAEODPage,
      meta: { requiresAuth: true, role: "bda" },
    },
    {
      path: "/bda/interviews",
      name: "BDABehavioralInterviewPage",
      component: BDABehavioralInterviewPage,
      meta: { requiresAuth: true, role: "bda" },
    },
    {
      path: "/bda/leaves",
      name: "BDALeavePage",
      component: BDALeavePage,
      meta: { requiresAuth: true, role: "bda" },
    },
    {
      path: "/bda/notifications",
      name: "BDANotificationsPage",
      component: BDANotificationsPage,
      meta: { requiresAuth: true, role: "bda" },
    },
    {
      path: "/ho/notifications",
      name: "HONotificationsPage",
      component: HONotificationsPage,
    ...
    {
      path: "/ho/task-management",
      name: "TaskManagement",
      component: TaskManagement,
      meta: { requiresAuth: true, role: "ho" },
    },
    {
      path: "/ho/technical-interviews",
      name: "HOTechnicalInterviews",
      component: HOTechnicalInterviews,
      meta: { requiresAuth: true, role: "ho" },
    },
    {
      path: "/ho/leaves",
      name: "HOLeavePage",
      component: HOLeavePage,
      meta: { requiresAuth: true, role: "ho" },
    },
    {
      path: "/ho/vacancies",
      name: "HOVacancyPage",
      component: HOVacancyPage,
      meta: { requiresAuth: true, role: "ho" },
    },
    {
