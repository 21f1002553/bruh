      ...
      <div class="course-sections">
        ...
        <div class="course-section" v-if="enrolledCourses.length > 0">
          ...
          <div class="course-grid">
            <div v-for="enrollment in enrolledCourses" :key="`enrolled-${enrollment.course_id}`"
              ...
              <div class="course-content">
                ...
                <div class="progress-section">
                  ...
                  <div class="progress-bar">
                    <div class="progress-fill" :style="{ width: enrollment.progress + '%' }"
                      :class="{ 'completed': enrollment.progress >= 100 }"></div>
                  </div>
                </div>
              </div>

              <div class="course-actions">
                <button @click="openCourse(enrollment.course)" class="btn-primary" :disabled="loading">
                  <i class="fas fa-play"></i>
                  {{ enrollment.progress >= 100 ? 'Review' : 'Continue' }}
                </button>

                <button v-if="enrollment.progress < 100" @click="updateProgress(enrollment.course.id, 100)"
                  class="btn-success" :disabled="loading">
        ...
        <div class="course-section">
          ...
          <div class="course-grid" v-if="filteredAvailableCourses.length > 0">
            <div v-for="course in filteredAvailableCourses" :key="`available-${course.id}`" class="course-card">
              <div class="course-header">
                <div class="course-title">
                  <h3>{{ course.title }}</h3>
              ...
              <div class="course-actions">
                <button @click="showEnrollmentModal(course)" class="btn-primary full-width" :disabled="loading">
      ...
      <div v-if="showModal" class="modal-overlay" @click="closeModal">
        <div class="modal-content" @click.stop>
          ...
          <div class="modal-footer">
            ...
            <button @click="enrollInCourse" class="btn-primary" :disabled="enrolling">
