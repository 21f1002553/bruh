  ...
  <div id="app">
    <div class="sidebar">
      ...
      <ul v-if="isCandidate">
        ...
        <li @click="navigate('candidate-profile')">
        ...
        <li @click="navigate('candidate-onboarding')">
          <a href="#"><i class="fas fa-user-plus"></i> Onboarding</a>
        </li>
        ...
        <li @click="navigate('Vacancies')">
          <a href="#"><i class="fas fa-hourglass"></i> Vacancies</a>
        </li>
        <li @click="navigate('Applications')">
          <a href="#"><i class="fas fa-file-lines"></i> Applications</a>
        </li>
      </ul>
      <ul v-else-if="isHR">
        ...
        <li @click="navigate('hr-reports')">
          <a href="#"><i class="fas fa-file-invoice-dollar"></i> Expense Reports Management</a>
        </li>
      ...
      <div class="sidebar-footer">
        <ul @click="logout"><a href="#"><i style="color: tomato" class="fas fa-arrow-right-from-bracket"></i>Logout</a>
        </ul>
      </div>
    </div>
...
function navigate(page) {
  ...
  const pageMap = {
    ...
    'hr-courses': '/hr/course-management',
    'hr-skills-assessment': '/hr/skills-assessment',
    'hr-reports': '/hr/expense-management',
    ...
    'ho-interviews': '/ho/technical-interviews',
    'ho-tasks': '/ho/task-management',
    'ho-leaves': '/ho/leaves',
